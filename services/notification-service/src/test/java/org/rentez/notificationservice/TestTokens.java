...
final class TestTokens {
	...
	/** A distinct recipient, for proving notifications are not readable by others. */
	static String customer(long userId) {
		return of("customer" + userId + "@nusiss.edu", "CUSTOMER", userId);
	}
